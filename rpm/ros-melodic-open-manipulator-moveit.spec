Name:           ros-melodic-open-manipulator-moveit
Version:        2.0.1
Release:        0%{?dist}
...
License:        Apache 2.0
URL:            http://wiki.ros.org/open_manipulator_moveit
...
BuildRequires:  ros-melodic-open-manipulator-description

%description
An automatically generated package with all the configuration and launch files
for using the open_manipulator with the MoveIt! Motion Planning Framework
